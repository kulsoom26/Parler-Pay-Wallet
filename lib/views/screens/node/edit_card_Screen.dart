...
class EditCardScreen extends GetView<NodeController> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        key: controller.scaffoldKeyEditCard,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                    hint: 'Security Number', controller: controller.number),
                SizedBox(
                  height: 24.h,
                ),
                Row(
