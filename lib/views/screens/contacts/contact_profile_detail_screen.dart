...
class ContactProfileDetailScreen extends GetView<ContactController> {
  const ContactProfileDetailScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        key: controller.scaffoldKeyContactProfileDetail,
                    ...
                    Obx(
                      () => GestureDetector(
                        onTap: () {
                          ...
                          controller.isBetweenUs.value = false;
                    ...
                    Obx(
                      () => GestureDetector(
                        onTap: () {
                          ...
                          controller.isBetweenUs.value = true;
                          controller.isNFT.value = false;
                        },
                        child: Container(
                          width: 121.w,
                          height: 36.h,
                          decoration: BoxDecoration(
                            color: controller.isBetweenUs.isTrue
                                ? kWhiteColor.withOpacity(0.12)
                                : Colors.transparent,
                            borderRadius: BorderRadius.circular(9999.r),
                            border: Border.all(
                              color: controller.isBetweenUs.isTrue
                                  ? kWhiteColor.withOpacity(0.2)
                                  : Colors.transparent,
                              width: controller.isBetweenUs.isTrue ? 1 : 0,
                            ),
                          ),
                          child: Center(
                            child: Text(
