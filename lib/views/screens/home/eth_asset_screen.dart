...
class ETHAssetScreen extends GetView<HomeController> {
  const ETHAssetScreen({super.key});
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [kBlueGradientColor3, kBlueGradientColor4],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
      ),
      child: Scaffold(
        key: controller.scaffoldKeyEthAsset,
        ...
        appBar: AppBar(
          ...
          leading: GestureDetector(
            ...
            child: Container(
              ...
              child: const Center(
                child: Icon(Icons.keyboard_arrow_left, color: kWhiteColor, size: 20),
              ),
            ),
          ),
          title: Row(
